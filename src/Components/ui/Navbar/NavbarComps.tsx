  ...
  return word.split("").map((letter, index) => {
    return (
      <motion.span
        ...
        className="inline-block whitespace-nowrap text-white font-semibold z-40 font-serif lg:text-[1.05rem] md:text-[0.9rem] text-[0.25rem] pointer-events-none mix-blend-difference "
      >
        {letter}
      </motion.span>
    );
